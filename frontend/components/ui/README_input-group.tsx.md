...
This README is tailored to the file's concrete shape, role, and likely coupling in the current repo. It intentionally documents source-derived facts and practical engineering context rather than generic prose.
...
- Fingerprint seed: $([math]::Abs(-1806147510))
